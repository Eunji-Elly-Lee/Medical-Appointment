<%-- 
    ...
    Created on : Mar 9, 2022, 2:57:08 AM
    Author     : ADMIN
--%>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-second">
                        <div class="col-md-5">
                            ...
                            <input type="text" id="phone_number" name="phone_number" value="${patient.mobile_phone}">
                        </div>

                        <div class="col-md-5">
                            <label for="alter_Phone_number">Alter Phone number: </label> <br>
                            <input type="text" id="alter_Phone_number" name="alter_Phone_number"
                                   value="${patient.alt_phone}">
                        </div>
                    </div>
                    <div class="row align-items-third">
                        ...
                        <div class="col-md-5">
                            ...
                            <select id="pref_contact_type" name="pref_contact_type">
                                <c:if test="${patient.pref_contact_type == 'MOBILE_PHONE'}">
                                    <option value="MOBILE_PHONE" selected>MOBILE_PHONE</option>
                                    <option value="EMAIL" >EMAIL</option>
                                    
                                </c:if>
                                <c:if test="${patient.pref_contact_type == 'EMAIL'}">
                    ...
                    <div class="row align-items-fourth">
                        <div class="col-lg-10">
                            ...
                            <input type="text" id="address" name="street_address"
                                   value="${patient.street_address}"><br>
                            <input type="text" id="address_second" name="postal_code" value="${patient.postal_code}">
                        </div>
                    </div>
                </div>
