        ...
        <div>
            ...
            <div>
                ...
                <div class="signup">
                    ...
                    <input type="text" name="appointment_date" value="${appointment.start_date_time}" >
                    <br>

                    <label for="assigned_doctor">Assigned Doctor</label>
                    <input type="text" name="assigned_doctor" value="Dr. ${doctor.last_name}" >

                    <label for="assigned_doctor">Patient</label>
                    <input type="text" name="assigned_doctor" value="${patient.first_name} ${patient.last_name}" readonly>
                    <br>

                    <form class="signup_form" action="edit_appointment" method="post">
