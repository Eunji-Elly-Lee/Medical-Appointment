...
<html>
    <head>        
        ...
        <style><%@ include file="/css/styleBackupPage.css" %></style>  
            ...
            <div class="headers">
                ...
                <div class="p-0 mobile_nav">
                    <div class="pe-2 mobile_header">
                        ...
                        <div><span class="hello">Hello ${backupUser.first_name}</span>
                            <img
                ...
                <div class="functional_links">
                    ...
                    <span>Hello, ${backupUser.first_name} ${backupUser.last_name}</span>
                    <div class="clear"></div>
                </div>
            </div>
